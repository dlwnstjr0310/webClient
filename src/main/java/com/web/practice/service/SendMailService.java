...
import com.web.practice.model.dto.MailDTO;
...
public class SendMailService {
	...
	public void createMailAndChangePassword(Employee employee) {
		...
		MailDTO script = MailDTO.builder()
				...
				.title(employee.getEmpName() + " 님의 임시 비밀번호 안내 관련 이메일입니다.")
				.message("안녕하세요. [ " + employee.getEmpName() + " ] 님의 임시 비밀번호는 " + str + " 입니다.")
				.build();

		mailSend(script);
		employee.setPassword(passwordEncoder.encode(str));
